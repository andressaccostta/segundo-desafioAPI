...
@Repository
public class DisciplinaRepository_old {
...
public Disciplina atualizar(Disciplina disciplina){
    ...
    // Eu tenho que remover a disciplina antiga da lista
    deletar(disciplina.getId());

    // Depois adicionar a disciplina atualizada na lista
